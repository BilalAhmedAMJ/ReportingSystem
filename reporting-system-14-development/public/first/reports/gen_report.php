...
$_SESSION['gs_reports'] = array ( "year" => $year,
		"status" => $status,
		"office" => $report_code,
		"show_office" => $show_office,
		"saiq_report" => $saiq_report,
               "branch" => $branch);
		...
		<table border="0" width="100%">
			<tr>
					  ...
					  <table width="100%" border="0">
						<tr>
							<td colspan="2">
								<table border="0" width="100%">
									<tr>
										<td align="left" nowrap><img src="/images/topbar-left.png" height=45></td>
						...
						<tr bgcolor="#cccccc">
						  <td colspan="2">
						   ...
						   <?if (($month=="all") && ($gs_report=="on")) {?>
								  <tr bgcolor="#cccccc">
									<th colspan="15"><span class=""><font color="#000000">Reports received during <? echo $year; ?></font></span></th>
								  </tr>
								  <tr  bgcolor="#cccccc">
									<td align="center"><span class=""><font color="#000000">Branch</font></span></td>
									<td align="center"><span class=""><font color="#000000">Jul <? echo $year; ?></font></span></td>
									<td align="center"><span class=""><font color="#000000">Aug</font></span></td>
									<td align="center"><span class=""><font color="#000000">Sep</font></span></td>
									<td align="center"><span class=""><font color="#000000">Oct</font></span></td>
									<td align="center"><span class=""><font color="#000000">Nov</font></span></td>
									<td align="center"><span class=""><font color="#000000">Dec</font></span></td>
									<td align="center"><span class=""><font color="#000000">Jan <? echo $year+1; ?></font></span></td>
									<td align="center"><span class=""><font color="#000000">Feb</font></span></td>
									<td align="center"><span class=""><font color="#000000">Mar</font></span></td>
									<td align="center"><span class=""><font color="#000000">Apr</font></span></td>
									<td align="center"><span class=""><font color="#000000">May</font></span></td>
									<td align="center"><span class=""><font color="#000000">Jun</font></span></td>
									<td align="center"><span class=""><font color="#000000">Total<br>Reports</font></span></td>
									<td align="center"><span class=""><font color="#000000">Months<br>Count</font></td>
								  </tr>
									 <?
									  //Get all branches
				...
				if ($branch != 'all')
								  ...
								  <tr bgcolor="#cccccc">
									<th colspan="15"><span class=""><font color="#000000">Reports received during <?echo $year; ?>-<? echo $year+1; ?></font></span></th>
								  </tr>
								  <tr  bgcolor="#cccccc">
									<td align="center"><span class=""><font color="#000000">Branch</font></span></td>
									<td align="center"><span class=""><font color="#000000">Jul <? echo $year; ?></font></span></td>
			...
			//						  $query = "SELECT branch_name, branch_code FROM ami_branches where status=1 order by branch_name";
				if ($branch != 'all')
									  ...
									  <tr bgcolor="#cccccc">
										<th colspan="25"><span class=""><font color="#000000">Reports received during <? echo $months["$month"]; ?><?echo $year-1; ?>-<? echo $year; ?></font></span></th>
									  </tr>
									 <?
									  //Get all branches
...
// Saiq Report Begins
						...
						<table align=center bgcolor=white border=1 cellspacing=0 cellpadding=1 width=60%>
								  ...
								  <tr bgcolor="#cccccc">
									<th colspan="15"><span class=""><font color="#000000"><? echo $year; ?> Sa'iqin Report for <? echo $bname; ?></font></span></th>
								  </tr>
<?	
...
case when meeting1_minutes!='' then 'Yes' when meeting1_attachment != '' then 'Yes' else 'No' end 'Amila Meeting Minutes', case gbody_meeting when 1 then 'Yes' when 0 then 'No' end 'GB Meeting', case when gbody_brief_report!='' then 'Yes' when gbody_meeting_attachment != '' then 'Yes' else 'No' end 'GB Meeting Minutes', saiq1, saiq1_visit_in_person, saiq1_contact_by_phone, saiq2, saiq2_visit_in_person, saiq2_contact_by_phone, saiq3,  saiq3_visit_in_person, saiq3_contact_by_phone, saiq4,  saiq4_visit_in_person, saiq4_contact_by_phone, saiq5,  saiq5_visit_in_person, saiq5_contact_by_phone, saiq6,  saiq6_visit_in_person, saiq6_contact_by_phone, saiq7, saiq7_visit_in_person, saiq7_contact_by_phone,saiq8,  saiq8_visit_in_person, saiq8_contact_by_phone,saiq9,  saiq9_visit_in_person, saiq9_contact_by_phone, saiq10,  saiq10_visit_in_person, saiq10_contact_by_phone, saiq11,  saiq11_visit_in_person, saiq11_contact_by_phone, saiq12,  saiq12_visit_in_person, saiq12_contact_by_phone FROM `ami_all_gs_reports`, months WHERE month=month_num and ((year=$start_year and month>6) or (year=$end_year and month < 7)) and branch_code='$branch' order by year, month";
//print $query;
									 $result = @mysql_db_query($dbname,$query);
									  if ($result){
?>
								  <tr  bgcolor="#cccccc">
									<td align="center" colspan=8 rowspan=2><span class=""><font color="#000000">Month/Year</font></span></td>
									<td align="center" colspan=2><span class=""><font color="#000000">Amila Meetings</font></span></td>
									<td align="center" colspan=2><span class=""><font color="#000000">GB Meetings</font></span></td>
									<td align="center" colspan=3><span class=""><font color="#000000">Sa'iqin Report</font></span></td>
								  <tr  bgcolor="#cccccc">
									<td align="center"><span class=""><font color="#000000">Held</font></span></td>
									<td align="center"><span class=""><font color="#000000">Report</font></span></td>
									<td align="center"><span class=""><font color="#000000">Held</font></span></td>
									<td align="center"><span class=""><font color="#000000">Report</font></span></td>
									<td align="center"><span class=""><font color="#000000">Num.</font></span></td>
									<td align="center"><span class=""><font color="#000000">Visit</font></span></td>
									<td align="center"><span class=""><font color="#000000">Phone</font></span></td>
								  </tr>
<?
										$saiq_count = 0;
										$saiq_visit= 0;
										...
										while ($row = mysql_fetch_array($result)) {
											...
											if ($row['saiq6_contact_by_phone']>0) $saiq_phone++;
                                                                                        ...
                                                                                        if (trim($row['saiq11'])!='') $saiq_count++;
                                                                                        if ($row['saiq11_visit_in_person']>0) $saiq_visit++;
                                                                                        if ($row['saiq11_contact_by_phone']>0) $saiq_phone++;
                                                                                        if (trim($row['saiq12'])!='') $saiq_count++;
                                                                                        if ($row['saiq12_visit_in_person']>0) $saiq_visit++;
                                                                                        if ($row['saiq12_contact_by_phone']>0) $saiq_phone++;
...
?>
						...
						<tr>
						  <td colspan="2">&nbsp;</td>
							...
							<tr><td align="center">
								<input type="button" name="Print" value="Print" class="noPrint newstylesmallbutton" onclick="javascript:window.print();">
								&nbsp;&nbsp;&nbsp;<!--input type="button" name="Cancel" value="Cancel" class="noPrint ButtonCSS" onclick="javascript:window.location.href('gs_reports.php');"-->
								 <a href="gs_reports.php" class="noPrint newstylesmallbutton">&nbsp;&nbsp; Back &nbsp;&nbsp;</a	
							</td></tr>
							</table>
						  </td>
						</tr>
