...
<? if ($qr=="Y") {
	...
	if (($report_code) || ($qrrid)) {
	  ...
	  $read_only="readonly";?>
		...
		<tr><td ><span class=""><font color="white">&nbsp;</font></span><td></tr>
		<tr><td>
			<table border="0" width="100%" class="BoxCSS1">
				<tr>
					<td colspan=8>
			...
			<table border="0" width="100%" class="BoxCSS1">
				<tr>
					<td colspan=5>
						<table border=0 width=100% class="BoxCSS1">
							<tr>
								<td ><b>VISITS</b> (attach report if required)</td>
								<td align=right><b>Month</b></td>
								<td align=center width="80"><b>1</b></td>
								<td align=center width="80"><b>2</b></td>
								<td align=center width="80"><b>3</b></td>
		...
		<? // Tabligh reports?>
		<tr><td ><b>Please provide results of your efforts in performing your departmental duties. You may attach a detailed report. </b><td></tr>
		<tr><td>
			<table border="0" width="100%" class="BoxCSS1">
				<tr>
					<td colspan=7>
		...
		<tr><td>
			<table border="0" width="100%" class="BoxCSS1">
				...
				<tr>
					<td colspan=3>What strategy is devised to activate such members (attach detail) </td>
