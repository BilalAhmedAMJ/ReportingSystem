...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<?php include 'menu_dev.php'; ?></td>
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr valign="top">
                <td valign="top" align="center">
				<?php //include 'admin_header.php'; ?>
				 <table class="newstylemaintable">
					<tr>
...
//					    print "$query";
					...
					?>
						<tr>
							<td colspan=6 bgcolor=#eeeeee class=newstylefilterbox>
								<table border="0" width="100%" cellspacing=0 cellpadding=0> 
									<form name="list_report" method="post" action="list_reports_dev.php">
									<tr>
										<td>&nbsp;Month</td>
										<td>&nbsp;Year</td>
										...
										<td>&nbsp;Status</td>
							<? if ($user_level=="N") { ?> 
										<td>Help Requested</td>
							<? } ?>
										 <td rowspan=2 width=25% align="center"><input type="submit" name="Submit" value="Filter" class="newstylemenubutton"></td>
									</tr>
									<tr>
										<td>
	 ...
	 <?             if ( (($user_type=="GS") || ($user_type=="P") || ($user_level=="N")) && ($user_type!="E") )  {?>
			...
			<td align="right" colspan="8">
				 ...
				 <tr align="center" bgcolor="#ffffd0">
					<td width="100"><font color=""><b>Month & Year</b></font></td>
					<td width="200"><font color=""><b>Branch Name</b></font></td>
					<td width="200"><font color=""><b>Report Name</b></font></td>
					<td width="100"><font color=""><b>Date posted</b></font></td>
					<td width="120"><font color=""><b>Status</b></font></td>
