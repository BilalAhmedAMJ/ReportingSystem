<? if ($gs=="Y") {
	...
	if (($report_code) || ($gsrid)) {
	  ...
	  $read_only="readonly";?>
		...
		<? // Amila Meeting1?>
		<tr><td bgcolor="#000000"><span class=""><font color="white">1- Majlis `Amila Meeting</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				...
				<tr><td colspan="8" bgcolor="#c0c0c0">Minutes of meeting or attach meeting minutes below<td></tr>
		...
		<? // Amila Meeting2?>
		<tr><td bgcolor="#000000"><span class=""><font color="white">2- Majlis `Amila Meeting</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr>
					<td bgcolor="#c0c0c0" width="150">Meeting held<br>(Please check)</td>
		...
		<tr><td bgcolor="#000000"><span class=""><font color="white">General Body Meeting</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr>
					<td bgcolor="#c0c0c0" width="150">Meeting held<br>(Please check)</td>
				...
				<tr><td colspan="8">&nbsp;</td></tr>
				<tr><td colspan="8" bgcolor="#c0c0c0">Brief report of the meeting or attach report below<td></tr>
		...
		<? // Tajnid?>
		<tr><td bgcolor="#000000"><span class=""><font color="white">Tajnid (Attach details & the change of address form)</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr>
		...
		<? // Visits?>
		<tr><td bgcolor="#000000"><span class=""><font color="white">Visits (Attach report if required)</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr>
		...
		<tr><td bgcolor="#000000"><span class="">
		<? 
if (($branch_code=="CAL") || (substr($branch_code,0,1)=="I"))  {?>
                        <font color="white">Report of Sa'iqin by Halqa</font>
<?              } else { ?>
                        <font color="white">Report of Sa'iqin (One Sa'iq should have approx. 10 households in his Hizb)</font>
<?              } ?>

		<!--font color="white">Report of Sa'iqin (One Sa'iq should have approximately 10 households in his Hizb)</font-->
</span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr bgcolor="#c0c0c0">
					<td width="20">No.</td>
<? if (($branch_code=="CAL") || (substr($branch_code,0,1)=="I"))  {?>
					<td bgcolor="#c0c0c0" width="140">Name of Halqa</td>
<? } else { ?>
...
<!-- /////// EXCLUDE FOLLOWING DEPARTMENT REPORT SUBMITTED QUESTIONS //////
		...
		<? // Submitted Reports?>
		<tr><td bgcolor="#000000"><span class=""><font color="white">Monthly Reports Submitted. (Please check)</font></span><td></tr>
		<tr><td>
			<table border="0" width="580" class="BoxCSS1">
				<tr>
