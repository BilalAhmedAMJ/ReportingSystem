...
/*		mail("samer@microcan.net", $subj, $message, "From:$sndr"); */
		////// BEGIN TEST CODE ////
	//			if ($PRINTED!=1) {
						...
						<td align="center">
							...
							<td>
							  ...
							  <table width="350" border="0">
								<tr>
										<td colspan=2 >Send an e-mail reminder to users to complete report for the following month.<br></td>
								</tr>
<tr>
                                                                                <td></td>
                                                                                <td>
									...
									<? if ($user_dept=="All") { ?>
								<tr>
										<td colspan=2 ><br>E-mail will be sent to users based on the following selection (To send reminder to all office bearers choose 'All'). <br></td>
								</tr>
  ...
  <tr>                                                                  
									...
									<tr bgcolor="#FFF5EE">
										 <td>Message:</td>
										<td><textarea class="BoxCSS1" name="r_mesg" <? echo $read_only; ?> cols="70" rows="10"><? echo $rMesg; ?></textarea>
										  </td>
									  </tr>
