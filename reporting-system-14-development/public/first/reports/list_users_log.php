          ...
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr valign="top">
                <td valign="top" align="center">
				 <table width=90% class="newstyletable">
					<tr >
					<th colspan="3">Users Login Log</th>
					</tr>
					<tr><td>
					<table >
				 	<?
					...
					///////////////////////////////////////////////////////////////
						...
						$query = 	"SELECT l.datetime, l.ip, a.user_name, a.user_id, a.user_type, case a.user_level when 'N' then 'National' else 'Local' end as user_level
, case a.user_type when 'P' then 'President' else b.report_name end as report_name, a.branch_code, c.branch_name, l.status
FROM ami_users_log l left join ami_users a on a.user_id=l.user_id
left join ami_reports b on a.user_type=b.report_code ,ami_branches c WHERE a.branch_code = c.branch_code";
						...
						$query .= " ORDER BY datetime desc, ip asc, user_id asc";
				 ...
				 <tr>
							<td colspan="8" >
								<table border="0" cellspacing=0 cellpadding=0 width="100%">
									<form name="list_report_log" method="post" action="list_users_log.php">
									<tr>
										<? if ($user_dept=="All") { ?>
										<td>&nbsp;Office</td>
										<? }?>
										...
										<? }?>
										<td>&nbsp;Status</td>
										<td rowspan=2 width=25% align="center"><input type="submit" name="Submit" value="Apply Filter" class="newstylesmallbutton"></td>
									</tr>
									<tr>
										<? if ($user_dept=="All") { ?>
										<td>
										...
										<select name="status">
											...
											<option <? if ($status=="0") print "selected"; ?> value="0">Denied</option>
											<option <? if ($status=="1") print "selected"; ?> value="1">Success</option>
										</select>
										</td>
									</tr>
									</form>
				 ...
				 <tr align="center">
					<td width="150" class=newstylecolumnheader><font color=""><b>Date Time</b></font></td>
					<td width="250" class=newstylecolumnheader><font color=""><b>Name</b></font></td>
					<td width="50" class=newstylecolumnheader><font color=""><b>User ID</b></font></td>
					<td width="150" class=newstylecolumnheader><font color=""><b>Branch Name</b></font></td>
					<td width="200" class=newstylecolumnheader><font color=""><b>Department</b></font></td>
					<td width="50" class=newstylecolumnheader><font color=""><b>Level</b></font></td>
					<td width="50" class=newstylecolumnheader><font color=""><b>Status</b></font></td>
					<td width="200" class=newstylecolumnheader><font color=""><b>IP Address</b></font></td>
				</tr>
				 <?
							$currow = 1;
							 while ($row = mysql_fetch_array($result2))
							 {
									...
									print "<td style=\"padding:2px;\">" . $row["datetime"] . "</td>\n";
								...
								if (($row["user_level"] == 'National') && ($row["branch_code"]!=$nat_branch))
									...
									if($status1 == "0")
									{
										print "<td align=\"center\" style=\"padding:2px;\"><font color=\"red\">Denied</td>\n";
									}
									else
									{
										print "<td align=\"center\" style=\"padding:2px;\">Success</td>\n";
									}
									print "<td style=\"padding:2px;\">" . $row["ip"] . "</td></tr>\n";
									$currow++;
								 }
	  ...
	  <? if ($numrows > $limit) { ?>
						...
						if ($skip >=1) {
						  if ($search) {
						  	print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=0&$search\">First</a> | ";
						  } else {
						  	print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=0\">First</a> | ";
						  }
						} else {
						  print "First | ";
								}
						...
						if ($skip>=1) {
						  ...
						  if ($search) {
						  	print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$prevoffset&$search\">Previous</a> | ";
						  } else {
						  	print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$prevoffset\">Previous</a> | ";
						  }
						} else {
						  print "Previous | ";
						}
						...
						if ((($skip/$limit)!= $pages) && $pages!=0) {
						  ...
						  if ($search) {
						  	print "&#160;<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$newoffset&$search\">Next</a> | ";
						  } else {
						  	print "&#160;<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$newoffset\">Next</a> | ";
						  }
						} else {
						  print "Next | ";
						}
						...
						if ($skip<$lastoffset) {
						  if ($search) {
							print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$lastoffset&$search\">Last</a> ";
						  } else {
						  	print "<a calss=newstylesmallbutton href=\"".$HTTP_SERVER_VARS['PHP_SELF']."?skip=$lastoffset\">Last</a> ";
						  }
						} else {
						  print "Last ";
						}
